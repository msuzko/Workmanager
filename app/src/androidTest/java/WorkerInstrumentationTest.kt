...
class WorkerInstrumentationTest {
    private val mockUriInput: Pair<String, String> =
        KEY_IMAGE_URI to "android.resource://com.mec.bluromatic/drawable/android_cupcake"
    ...
    fun blurWorker_doWork_resultSuccessReturnsUri() {
        ...
        runBlocking {
            ...
            assertTrue(
                resultUri?.startsWith("file:///data/user/0/com.mec.bluromatic/files/blur_filter_outputs/blur-filter-output-")
                    ?: false
            )
        }
    }
